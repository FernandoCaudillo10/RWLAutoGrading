...
class StudViewClass extends React.Component {
  ...
  renderTableData() {
        return this.state.classes.map((c, index) => {
            const { class_id, professor_email, name, section_id } = c
            return (
                <div className="classInfo">
                    <text><b>Class ID:</b>  {class_id}</text><br></br>
                    <text><b>Class:</b>  {name}</text><br></br>
                    <text><b>Professor Email:</b>  {professor_email}</text><br></br>
