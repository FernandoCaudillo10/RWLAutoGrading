    ...
    return (
      <div className="Login">
        ...
        <form onSubmit={this.handleSubmit}>
          <div>
            <input className="LoginFields" type="text" placeholder="Email" name="email" onChange={this.handleFormChange} required />
          </div>
          <div>
            <input className="LoginFields" type="password" placeholder="Password" name="password" onChange={this.handleFormChange} required />
          </div>
          <select value={this.state.typeOfUser} onChange={this.handleSelectOption} required>
            <option value="" name="typeOfUser" />
...
const mapDispatchToProps = (dispatch) => ({
  onLogin: (token, UserType) => dispatch({ type: 'USER_LOGIN', token, UserType }),
});
