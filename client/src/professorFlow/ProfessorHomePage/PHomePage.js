      ...
      this.items = this.state.information.map((item, key) => (
        <div key={item.class_id}>
          <div className="professorClassSecBody">
            ...
            <div>
              <div>
                <Link to={`/professor/class/${item.class_id}/assignments`}>
                  {' '}
                  <input type="submit" value="View/Edit Assignments" />
                  {' '}
                </Link>
                <Link to={`/professor/class/${item.class_id}/assignment/create`}>
                  {' '}
