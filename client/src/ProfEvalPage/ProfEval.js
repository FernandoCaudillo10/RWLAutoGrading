...
*/
	...
	postEvaluation = (eArr) => {
		axios({
                method: 'post',
                url: 'https://rwlautograder.herokuapp.com/api/prof/class/evaluation/submit',
                data:  qs.stringify({
				...
				return (
						<div>
							...
							<div className="sliderContainer"> 
								...
								<ProfSlider evalID={evalID} type="clarity" callbackFromParent={this.myCallback}/>
							</div>
							<div className="sliderContainer"> 
								<div className="sliderText">
									<b>Grammar:</b>
								</div> 
								<ProfSlider evalID={evalID} type="grammar"/>
							</div>
							<div className="sliderContainer"> 
								<div className="sliderText">
									<b>Response:</b>
								</div> 
								<ProfSlider evalID={evalID} type="response"/>
							</div>
						</div>
				)
			});
